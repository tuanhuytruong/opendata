...
export default function ReportBuilder({ runId, report, language, onChange }: Props) {
  ...
  const selectBlock = (blockId: string) => setSelectedId(current => current === blockId ? current : blockId);
