...
const icons: Record<string, typeof BarChart3> = { bar: BarChart3, line: LineChart, area: AreaChart, pie: PieChart, donut: CircleDot, scatter: ScatterChart, stacked_bar: ChartNoAxesCombined, combo: ChartNoAxesCombined };
const labels: Record<string, { en: string; vi: string }> = { bar: { en: 'Bar', vi: 'Cột' }, line: { en: 'Line', vi: 'Đường' }, area: { en: 'Area', vi: 'Miền' }, pie: { en: 'Pie', vi: 'Tròn' }, donut: { en: 'Donut', vi: 'Vành khuyên' }, scatter: { en: 'Scatter', vi: 'Phân tán' }, stacked_bar: { en: 'Stacked bar', vi: 'Cột chồng' }, combo: { en: 'Combo', vi: 'Kết hợp' } };
