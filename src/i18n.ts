...
const copy = {
  en: {
    ...
    copilot: 'Data Copilot', runScoped: 'Run-scoped', ask: 'Ask about this dataset…', askHelp: 'I will ask for confirmation when a metric, time field, or business meaning is unclear.',
  ...
  vi: {
    ...
    copilot: 'Data Copilot', runScoped: 'Theo run', ask: 'Hỏi về dataset này…', askHelp: 'Em sẽ hỏi lại khi metric, trường thời gian hoặc business meaning chưa rõ.',
