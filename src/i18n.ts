...
const copy = {
  en: {
    ...
    overviewTitle: 'Executive data overview', overviewSub: 'Automatic validated aggregate overview from the active dataset.', overviewGenerated: 'Generated executive overview', overviewGuardrail: 'All charts are validated server aggregates.', reportEmptyTitle: 'Your report is ready to curate', reportEmptySub: 'Add verified findings from AI Data Chat to build an evidence-backed report.',
  ...
  vi: {
    ...
    overviewTitle: 'Tổng quan dữ liệu điều hành', overviewSub: 'Tổng quan aggregate tự động, đã xác thực từ dataset đang chọn.', overviewGenerated: 'Tổng quan điều hành đã tạo', overviewGuardrail: 'Mọi chart đều là aggregate đã xác thực trên server.', reportEmptyTitle: 'Báo cáo đang chờ được chọn lọc', reportEmptySub: 'Thêm phát hiện đã xác thực từ AI Data Chat để tạo báo cáo có evidence.',
